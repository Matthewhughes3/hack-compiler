...
evalStatement cn fn (LetStatement (i, e)) (symbols, code) = let (vs, _, vi) = case lookup (i,fn) symbols of
...
evalStatement cn fn (IfElseStatement (e, ists, ests)) (symbols, code) = let ce = evalExpression cn fn e (symbols, code)
...
evalStatement cn fn (WhileStatement (e, sts)) (symbols, code) = let ce = evalExpression cn fn e (symbols, code)
...
evalStatement cn fn (ReturnStatement e) sc = let value = case e of
